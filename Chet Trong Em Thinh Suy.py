...
pygame.display.set_caption("Chết Trong Em - Thịnh Suy")
...
lyrics = [
    ...
    ("Chết trong em một niềm tin chôn giấu", 330, 2300, (255, 80, 80)),
...
sparkles = [Sparkle(random.randint(0, WIDTH), random.randint(0, HEIGHT), random.randint(2, 5)) for _ in range(40)]
